...
public class Config {
    ...
    public static final String api_key = "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";

    public static class PreguntasChat extends AppCompatActivity implements SpeechRecognizer.Listener,  TextToSpeech.OnInitListener{
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_preguntaschat);
            ...
            isVoiceEnabled = getSharedPreferences("EmergencyAlter", MODE_PRIVATE).getBoolean("CHECKRESPVOICE", true);
            ...
            checkboxVoiceResult.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    getSharedPreferences("EmergencyAlert", MODE_PRIVATE).edit().putBoolean("CHECKRESPVOICE", isChecked).apply();
                }
            });
        }
